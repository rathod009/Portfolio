...
const elegantCoral = Color(0xffFF6F61); // Elegant Coral Color

class AppTheme {
  static final _core = AppCoreTheme(
    shadowSub: elegantCoral.withAlpha(100),
    primary: elegantCoral,
    primaryLight: elegantCoral.withAlpha(100),
